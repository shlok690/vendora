      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: '#94a3b8', fontSize: '0.9rem', marginTop: '0.4rem' }}>
            Register as a {role === 'vendor' ? 'Vendor' : role === 'customer' ? 'Customer' : 'Platform'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '0.75rem', marginBottom: '0.25rem' }}>
            <Link
              ...
              style={{
                textDecoration: 'none',
                color: role === 'vendor' ? '#fff' : '#38bdf8',
                fontWeight: 600,
                background: role === 'vendor' ? 'linear-gradient(135deg, #6366f1 0%, #4f46e5 100%)' : 'transparent',
            ...
            <Link
              ...
              style={{
                textDecoration: 'none',
                color: role === 'customer' ? '#fff' : '#38bdf8',
                fontWeight: 600,
                background: role === 'customer' ? 'linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%)' : 'transparent',
                padding: '0.5rem 0.9rem',
                borderRadius: '999px',
              }}
            >
