      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          <h1 style={{ fontSize: '1.75rem', fontWeight: 800, margin: 0, color: '#fff' }}>
            {isAdmin ? 'Admin Login' : isVendor ? 'Vendor Login' : isCustomer ? 'Customer Login' : 'User Login'}
          </h1>
          <p style={{ color: '#94a3b8', fontSize: '0.9rem', marginTop: '0.4rem' }}>
            {isAdmin
              ? 'Sign in to access the administration dashboard.'
              : isVendor
              ? 'Sign in to access your vendor onboarding dashboard.'
              : isCustomer
              ? 'Sign in to access the marketplace and explore products.'
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '0.75rem', marginBottom: '1.25rem' }}>
          <Link
            ...
            style={{
              textDecoration: 'none',
              color: isVendor ? '#fff' : '#38bdf8',
              fontWeight: 600,
              background: isVendor ? 'linear-gradient(135deg, #0ea5e9 0%, #6366f1 100%)' : 'transparent',
          ...
          <Link
            ...
            style={{
              textDecoration: 'none',
              color: isCustomer ? '#fff' : '#38bdf8',
              fontWeight: 600,
              background: isCustomer ? 'linear-gradient(135deg, #0ea5e9 0%, #6366f1 100%)' : 'transparent',
              padding: '0.5rem 0.9rem',
              borderRadius: '999px',
            }}
          >
