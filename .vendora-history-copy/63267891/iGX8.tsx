      ...
      <main id="top">
        <section className="hero-section">
          <div className="hero-copy">
            ...
            <h1>
              Welcome to <span>Vendora</span>
            </h1>
            <p className="hero-text">
              Empower local vendors and customers with a modern marketplace for product
              discovery, selling, and shopping—all in one beautifully simple platform.
            </p>
        ...
        <section className="section about-section" id="about">
          <div>
            ...
            <p>
              Vendora brings local sellers and buyers onto the same marketplace experience so
              products are easier to discover, communication is faster and transactions feel
              effortless.
            </p>
          </div>
