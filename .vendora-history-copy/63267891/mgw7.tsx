...
function LandingPage() {
  ...
  const dashboard = userRole === 'vendor'
    ? '/seller-dashboard'
    : userRole === 'customer'
      ? '/buyer-dashboard'
      : '/login';
  const dashboardReady = currentUser && !loading && !!userRole;
    ...
    <header className="home-nav">
      ...
      <div className="home-actions">
        <button
          ...
          aria-busy={loading && currentUser != null}
        >
          Dashboard
        </button>
  ...
  <div className="hero-waves"><span /><span /><span /></div>
    <main>
      <section className="home-hero">
        ...
        <div className="hero-cta"><Link className="button button-dark" to="/register">Explore Vendora</Link></div>
      </section>
